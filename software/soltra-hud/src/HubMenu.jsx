...
const REVEAL_CONTENT = [
  {
    upper: ["SOLTRA AI OVERSEER", "STATUS: ONLINE"],
    lower: "launch the ai-driven virtual avatar for natural language interaction and system queries.",
  },
  {
    upper: [
    ...
    lower: "view real-time data streams from the hardware arrays, including wind, solar irradiance, and motor positions.",
  },
  {
    upper: [
      "MANUAL HARDWARE CONTROL",
      "WARNING: SAFETY OVERRIDES DISABLED",
    ],
    lower: "direct access to the linear actuators for maintenance and calibration. authorized personnel only.",
  },
];

const ROLES = [
  { text: "AI",  color: "#00d9ff", bg: "rgba(0,217,255,0.12)", border: "rgba(0,217,255,0.5)" },
  { text: "DATA", color: "#ff2a2a", bg: "rgba(255,42,42,0.12)", border: "rgba(255,42,42,0.5)" },
  { text: "CTRL", color: "#e8c100", bg: "rgba(232,193,0,0.12)", border: "rgba(232,193,0,0.5)" },
];

const ITEMS = [
  {
    id: "vrm", label: "AI OVERSEER", route: "/system", icon: "🤖", barIcon: icon1, bars: 1, newBars: [0], counts: ["ONLINE"],
    links: ["system.soltra/vrm/core"],
    stats: [
      { tag: "UPL", value: "OK", color: "#00d9ff" },
    ],
  },
  {
    id: "telemetry", label: "SENSOR TELEMETRY", route: "/logs", icon: "📊", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["LIVE"],
    links: ["system.soltra/data/stream"],
    stats: [
      { tag: "FPS", value: "60", color: "#ff2a2a" },
    ],
  },
  {
    id: "manual", label: "MANUAL CONTROL", route: "/manual", icon: "⚙️", barIcon: icon3, bars: 7, newBars: [0, 3], counts: ["LOCKED"],
    links: ["system.soltra/hw/override"],
    stats: [
      { tag: "AUTH", value: "REQ", color: "#e8c100" },
    ],
  },
];
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter") {
        ...
        else navigate(ITEMS[active].route);
      }
  ...
  return (
    <div id="menu-screen">
      ...
      <div className={`sc-footer${mounted ? " mounted" : ""}`}>
        ...
        <div className="sc-footer-row"><span className="sc-footer-key">↵</span><span>{revealed ? "LAUNCH" : "REVEAL"}</span></div>
        <div className="sc-footer-row"><span className="sc-footer-key">ESC</span><span>BACK</span></div>
      </div>

      <div className="sc-quick-actions" style={{ pointerEvents: "auto" }}>
        <button className="sc-quick-btn" onClick={() => setShowVoiceCloning(true)}>VOICE CLONE</button>
        <button className="sc-quick-btn" onClick={() => navigate("/settings")}>SETTINGS</button>
        <button className="sc-quick-btn" onClick={() => {
