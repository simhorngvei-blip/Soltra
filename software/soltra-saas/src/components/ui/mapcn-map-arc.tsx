...
function MapPopup({
  ...
  }, [popupOptions, longitude, latitude, popup]);
...
export { Map, MapMarker, MarkerContent, MarkerPopup, MarkerTooltip, MarkerLabel, MapControls, MapPopup, MapRoute, MapArc, useMap, useMarkerContext };